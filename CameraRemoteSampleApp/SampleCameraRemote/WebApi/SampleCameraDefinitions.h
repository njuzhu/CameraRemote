...
static NSString *API_CAMERA_setContShootingMode = @"setContShootingMode";
static NSString *API_CAMERA_getContShootingMode = @"getContShootingMode";
static NSString *API_CAMERA_setContShootingSpeed = @"setContShootingSpeed";
static NSString *API_CAMERA_getContShootingSpeed = @"getContShootingSpeed";
static NSString *API_CAMERA_setExposureMode = @"setExposureMode";
static NSString *API_CAMERA_getExposureMode = @"getExposureMode";
static NSString *API_CAMERA_setExposureCompensation = @"setExposureCompensation";
static NSString *API_CAMERA_getAvailableExposureCompensation = @"getAvailableExposureCompensation";
static NSString *API_CAMERA_getSupportedExposureCompensation = @"getSupportedExposureCompensation";
